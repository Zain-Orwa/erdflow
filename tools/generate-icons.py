...
def build_all():
    ...
    G["pan"] = ("blue", f'''
        <path d="M44 74 V40 C44 33 55 33 55 40 V62 V30 C55 23 66 23 66 30 V60 V26
                 C66 19 77 19 77 26 V60 V38 C77 31 88 31 88 38 V74
                 C88 96 77 110 64 110 C48 110 40 96 40 82 C40 70 44 68 44 74 Z" {F}/>''')
    ...
    G["undo"] = ("blue", f'''
        <path d="M40 34 L16 58 L40 82"/>
        <path d="M18 58 H74 C96 58 110 74 110 92 C110 100 108 106 104 112"/>''')

    G["redo"] = ("blue", f'''
        <path d="M88 34 L112 58 L88 82"/>
        <path d="M110 58 H54 C32 58 18 74 18 92 C18 100 20 106 24 112"/>''')
